...
def get_new_patterns():
    ...
    # samples, sents_dict = build_data(data, preprocessing_type='lemmatize')      # po sholtim al eize haxlafot naasot
...
def create_new_patterns_dict():
    ...
    replacements_dict = load_dict_from_txt(COPY_SYNONYMS_PATH)
    new_patterns_dict = {}
